...
DEST    defw    $437f
E_LINE  defw    _eline
CH_ADD  defw    _eline+13
X_PTR   defw    0
STKBOT  defw    _eline+14
STKEND  defw    _eline+14
BERG    defb    $48
MEM     defw    TABLES
SPARE1  defb    0
DF_SZ   defb    2
...
INIT    ld      hl, TABLES      ; Mueve tablas a zona de variables
        ...
        ld      bc, INIT-TABLES
        ldir
        jp      DRIVER          ; Salta al bucle principal

SPARE2  defw    0

line01  defb    0, 1
        defw    line02-line01-4
        defb    $ea             ; REM
...
DRIVER2 call    TL              ; Comprueba si hay más movimientos en la lista y
        ...
        dec     (hl)            ; estos 2 bytes quedan libres
        nop
...
line02  defb    0, 2
        defw    line03-line02-4
        defb    $e4             ; SLOW
        defb    $76

line03  defb    12, 10
        defw    _dfile-line03-4
        defb    $f9, $d4, $3d   ; RAND USR X
        defb    $76

_dfile  defb    $76, $76, $76, $76, $76
                        ;$a9, $b7, $ad  ; DRH (iniciales de David Richard Horne)
prilin  defb    $80,$08, $00, $00, $00  
...
_vars   defb    $7d                     ; X
        defb    $8f, $00, $da, $00, $00 ; 16493 (406d) (INIT)
