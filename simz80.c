/* Z80 instruction set simulator.
   GPL2 1995 Frank D. Cringle Modifications single stepping 2010 by Andre de Leiradella */
/* This file was generated from simz80.pl
   with the following choice of options */

extern struct z80 z80;
char *perl_params =
    "combine=0,"
    "optab=0,"
    "cb_inline=1,"
...
#define GetBYTE(a)      ( z80_read (  ( a ) & 0xffff ) )
#define GetBYTE_pp(a)	( z80_read (  ( a )++ & 0xffff ) )
#define GetBYTE_mm(a)   ( z80_read (  ( a )-- & 0xffff ) )
#define mm_GetBYTE(a)   ( z80_read (  --( a ) & 0xffff ) )
#define PutBYTE(a, v)   ( z80_write(  ( a ) & 0xffff, ( v ) ) )
#define PutBYTE_pp(a,v)	( z80_write(  ( a )++ & 0xffff, ( v ) ) )
#define PutBYTE_mm(a,v)	( z80_write(  ( a )-- & 0xffff, ( v ) ) )
#define GetWORD(a)      ( (WORD)z80_read(  a ) | (WORD)( z80_read(  ( a ) + 1 ) << 8 ) )

#define PutWORD(a, v)							\
    do { z80_write( a, (BYTE)(v));						\
	       z80_write( (a)+1, (v) >> 8);						\
     } while (0)

#define Input( a )     ( z80_in(  a ) )
#define Output( a, v ) ( z80_out(  ( a ), ( v ) ) )

#define POP(x)	do {							\
	FASTREG y = z80_read( SP++);						\
	x = y + (z80_read( SP++) << 8);					\
} while (0)
...
void z80_step(  )
{
  ...
  switch( z80_fetch( PC++ ) ) {
	...
	case 0xDA:			/* JP C,nnnn */
		...
		break;
	case 0xDB:			/* IN A,(nn) */
		Sethreg(AF, Input((AF & 0xff00) | GetBYTE_pp(PC)));
		break;
